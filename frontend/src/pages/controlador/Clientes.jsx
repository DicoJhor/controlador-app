...
const IC = {
  ...
  id:       "M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2z M12 12h.01",
  ...
  return (
    <div style={{ border: "1px solid var(--border)", borderRadius: 10, overflow: "hidden", marginBottom: 10 }}>
      <div onClick={() => setAbierto(p => !p)}
        style={{ padding: "10px 14px", background: "var(--hover, #f8f9fa)", cursor: "pointer",
...
export default function Clientes() {
  ...
  const esControlador = userRol === 'controlador'
  ...
  // ── Carga sedes solo si no es controlador ──────────────────────────────────
  useEffect(() => {
    if (!esControlador) {
  ...
  const exportarExcel = async (soloEsteCliente = false) => {
    ...
    try {
      ...
      const nombre = soloEsteCliente && clienteSel
    ...
    <>
            ...
            <div style={{ padding: "14px 20px", borderBottom: "1px solid var(--border)" }}>
              <div style={{ display: "flex", justifyContent: "space-between",
                ...
                {!editando
                  ...
                  : <div style={{ display: "flex", gap: 6 }}>
                      <button className="btn btn-outline btn-sm"
                        onClick={() => setEditando(false)} disabled={saving}>
                        Cancelar
                      </button>
              ...
              {editando ? (
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  ...
                  {/* Selector de sede solo para admin y superadmin */}
                  {!esControlador && (
                    <div className="form-group" style={{ margin: 0 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={styles.sectionHeader}>
          <div>
            ...
            <div style={styles.sectionSubtitle}>
              Directorio de clientes con historial de contratos y servicios
            </div>
          </div>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
          ...
          {/* Selector de sede: solo admin y superadmin */}
          {!esControlador && (
